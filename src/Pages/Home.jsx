...
const StatusBadge = memo(() => (
  <div className="inline-block animate-float lg:mx-0 mt-10 sm:mt-2 md:mt-2 lg:mt-1 pt-10 sm:pt-2 md:pt-2 lg:pt-1" data-aos="zoom-in" data-aos-delay="400">
...
const TECH_STACK = ["Javascript", "React", "PHP", "Laravel"];
const SOCIAL_LINKS = [
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[8%] lg:py-[3%] min-h-screen">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Full-Stack Web Development From Interactive User <br /> Interface to Infrastructure, Building Modern Web <br /> Applications that are Functional, Responsive, <br /> and User-Friendly.
                </p>
