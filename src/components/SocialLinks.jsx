...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/haikal-apriansyah-004849291/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@haiklaprsnyh",
    icon: Instagram,
    url: "https://www.instagram.com/haiklaprsnyh/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@haikalll27",
    icon: Github,
    url: "https://github.com/haikalll27",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@haickalap?lang=id-ID",
    color: "black",
        ...
        >
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-bold pt-[0.2rem] text-gray-200 tracking-tight leading-none group-hover:text-white transition-colors duration-300">{linkedIn.displayName}</span>
